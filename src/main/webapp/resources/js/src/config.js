...
var config={
    ...
    qiNiu:{
        ...
        bucketDomain:"http://7xtna1.com1.z0.glb.clouddn.com/",
        swfUrl:"resources/js/lib/Moxie.swf"
    },
    ajaxUrls:{
        chineseCharacterGetAll:"chineseCharacter/list",
        chineseCharacterDelete:"chineseCharacter/delete/:id",
        specialDesignGetAll:"specialDesign/list",
        specialDesignDelete:"specialDesign/delete/:id"
    },
    dataTable:{
